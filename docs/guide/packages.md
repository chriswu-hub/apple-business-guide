...
本單元探討如何透過 Apple 商務的套件部署技術，在受管 Mac 上派送未於 Mac App Store 上架的企業專屬或客製化應用程式，並解析套件安裝與管理式 App 的本質區別。

---

### 🎯 學習目標
- 理解 macOS 套件（.pkg）的運作架構與適用場景
- 掌握套件安裝與管理式 App 的權限與生命週期差異
- 了解在 Apple 商務中建立與部署套件的前置條件
